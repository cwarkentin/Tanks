...
void SpriteConfig::insert(SpriteType st, Rect rect, int frames_count, unsigned frame_duration, bool loop)
{
    m_configs[st] = SpriteData{rect, frames_count, frame_duration, loop};
}
